...
const LABEL_DATA = {
  'trex-liquid': {
    ...
    ingredients: [
      {
        name: 'Fulvic Acid',
        scientificName: 'Shilajit-derived fulvic complex',
        amount: '2.2g',
        perLabelDose: '2.2g',
        standardization: 'Fulvic complex from Himalayan shilajit',
        origin: 'Himalayan shilajit resin',
        keyBenefit: 'Mineral transport · Absorption carrier',
        mechanism:
          'Fulvic acid is the active fraction of shilajit rather than a separate herb, which is why it appears on the panel at a far larger weight than the botanicals. It acts as a chelator and carrier, binding minerals and helping move the other compounds across the gut wall.',
        traditionalUse:
          'Shilajit resin has been collected from Himalayan rock seams and used in Ayurveda as a rasayana for centuries; fulvic acid is the constituent modern analysis credits with much of its activity.',
        emoji: '⚡',
      },
      {
        name: 'Himalayan Liquid Shilajit',
      ...
      {
        name: 'Gokhru (Tribulus Terrestris)',
      ...
      {
        name: 'Kath Badam (Almond Extract)',
    ...
    supplementFacts: {
      ...
      rows: [
        { name: 'Total Fat', amount: '0.004g', dv: '†', indent: false },
        { name: 'Protein', amount: '0.12g', dv: '†', indent: false },
        { name: 'Carbohydrate', amount: '3.8g', dv: '†', indent: false },
        { name: 'Dietary Fiber', amount: '3.8g', dv: '†', indent: false },
        { name: 'Iron', amount: '5.5mg', dv: '†', indent: false },
        { name: 'Calcium', amount: '4.4mg', dv: '†', indent: false },
        { name: 'Magnesium', amount: '0.5mg', dv: '†', indent: false },
        { name: 'Zinc', amount: '9.9mg', dv: '†', indent: false },
        { name: 'Fulvic Acid', amount: '2.2g', dv: '†', indent: false },
        { name: 'Ashwagandha', amount: '200mg', dv: '†', indent: false },
        { name: 'Himalayan Liquid Shilajit', amount: '100mg', dv: '†', indent: false },
        { name: 'Tribulus Terrestris', amount: '100mg', dv: '†', indent: false },
        { name: 'Safed Musli', amount: '200mg', dv: '†', indent: false },
        { name: 'Arjun Chal', amount: '200mg', dv: '†', indent: false },
        { name: 'Draksha', amount: '200mg', dv: '†', indent: false },
        { name: 'Almond Extract', amount: '200mg', dv: '†', indent: false },
        { name: 'Sarkara A.S.', amount: '400mg', dv: '†', indent: false },
      ],
      suggestedUse: 'Consume one tablespoon (10ml) once or twice daily. On workout days consume one serving 30 min prior to training.',
    },
  ...
  'trex-cordyceps': {
    ...
    supplementFacts: {
      ...
      caloriesPerServing: 0,
      rows: [
        { name: 'Cordyceps Sinensis (from high altitude Caterpillar larvae)', amount: '1,000mg', dv: '†', indent: false },
        { name: 'Equivalent from 10:1 Ratio', amount: '10,000mg', dv: '†', indent: true },
        { name: 'Ultra-Concentrated standardized for Maximum Bioactivity', amount: '', dv: '', indent: true },
      ],
      suggestedUse: 'Consume 2 capsules after breakfast.',
    },
  ...
  'trex-ginseng': {
    ...
    supplementFacts: {
      ...
      caloriesPerServing: 0,
      rows: [
        { name: 'Korean Panax Ginseng (Panax Root Extract)', amount: '1,000mg', dv: '†', indent: false },
        { name: 'Ultra-Concentrated standardized for Maximum Bioactivity', amount: '', dv: '', indent: true },
      ],
      suggestedUse: 'Consume 2 capsules after breakfast.',
    },
  ...
  'trex-maca': {
    ...
    supplementFacts: {
      ...
      caloriesPerServing: 0,
      rows: [
        { name: 'Black Maca Root Extract (Lepidium Meyenii)', amount: '1,000mg', dv: '†', indent: false },
        { name: 'Equivalent from 10:1 Ratio', amount: '10,000mg', dv: '†', indent: true },
        { name: 'Ultra-Concentrated standardized for Maximum Bioactivity', amount: '', dv: '', indent: true },
      ],
      suggestedUse: 'Consume 2 capsules after breakfast.',
  ...
  'trex-liver': {
    ...
    licenseNo: '',
    category: 'Herbal Supplement',
    servingSize: '2 capsules (after breakfast)',
    servingsPerBottle: 30,
    netVolume: '60 capsules',
    ingredients: [
      {
    ...
    supplementFacts: {
      ...
      caloriesPerServing: 0,
      rows: [
        { name: 'Gulancha (Tinospora cordifolia) St. A.S.', amount: '100mg', dv: '†', indent: false },
        { name: 'Rohitak Chhal (Tecomella undulata) St. Bk. A.S.', amount: '100mg', dv: '†', indent: false },
        { name: 'Mutha (Cyperus rotundus) Rz. A.S.', amount: '50mg', dv: '†', indent: false },
  ...
  'trex-royal-jelly': {
    ...
    servingSize: '2 capsules (1,000mg)',
    servingsPerBottle: 30,
    netVolume: '60 capsules',
    ingredients: [
      {
    ...
    supplementFacts: {
      ...
      caloriesPerServing: 0,
      rows: [
        { name: 'Royal Jelly (Apis Mellifera)', amount: '1,000mg', dv: '†', indent: false },
        { name: 'Ultra-Concentrated standardized for Maximum Bioactivity', amount: '', dv: '', indent: true },
      ],
      suggestedUse: 'Consume 2 capsules after breakfast.',
    },
