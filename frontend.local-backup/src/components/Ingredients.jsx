...
export default function Ingredients() {
  return (
    <section id="ingredients" className="py-28 relative overflow-hidden">
      ...
      <img src="/brand/dotted-circle.png" alt="" aria-hidden className="absolute -top-32 -right-40 w-[600px] opacity-10 mix-blend-lighten pointer-events-none" />
          ...
          {herbs.map((h) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-ink/40 border border-bone/10 flex items-center justify-center p-1.5 group-hover:border-amber/30 transition">
                <img src={h.icon} alt="" aria-hidden className="w-full h-full object-contain opacity-90" style={{ mixBlendMode: 'lighten' }} />
              </div>
